        ...
        <div>
            <div className="lg:h-[500px] h-[300px] sm:h-[350px] w-full relative">
                ...
                <div className='absolute inset-0 flex flex-col items-center justify-center w-full h-full'>
                    <h1 className='text-4xl font-bold uppercase text-slate-200'>Joining</h1>
                ...
                <img
                    src="https://images.pexels.com/photos/11608634/pexels-photo-11608634.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                    alt="img"
