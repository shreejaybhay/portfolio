        ...
        <div>
            <div className="lg:h-[500px] h-[300px] sm:h-[350px] w-full relative">
                ...
                <div className='absolute inset-0 flex flex-col items-center justify-center w-full h-full'>
                    <h1 className='text-4xl font-bold uppercase text-slate-200'>Training</h1>
                ...
                <img
                    src="https://images.pexels.com/photos/10246103/pexels-photo-10246103.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                    alt="img"
            ...
            <div>
                <div className='mt-20 xl:px-[300px] lg:px-10 px-3'>
                    <h1 className='text-2xl '>Started on <span className='text-slate-200'> June 13, 2024</span></h1>
                </div>
